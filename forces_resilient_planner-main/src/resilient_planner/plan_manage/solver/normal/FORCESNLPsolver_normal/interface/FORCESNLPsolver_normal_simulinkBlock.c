...
#define S_FUNCTION_NAME FORCESNLPsolver_normal_simulinkBlock
...
typedef FORCESNLPsolver_normalinterface_float FORCESNLPsolver_normalnmpc_float;

extern void FORCESNLPsolver_normal_casadi2forces(double *x, double *y, double *l, double *p, double *f, double *nabla_f, double *c, double *nabla_c, double *h, double *nabla_h, double *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	const solver_int32_unsigned *num_of_threads = (const solver_int32_unsigned*) ssGetInputPortSignal(S,3);
