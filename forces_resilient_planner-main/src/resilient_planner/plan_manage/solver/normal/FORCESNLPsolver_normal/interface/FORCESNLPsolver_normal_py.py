...
a Python wrapper for a fast solver generated by FORCESPRO v4.4.0
   ...
   OUTPUT = FORCESNLPsolver_normal_py.FORCESNLPsolver_normal_solve(PARAMS) solves a multistage problem
   ...
   [OUTPUT, EXITFLAG] = FORCESNLPsolver_normal_py.FORCESNLPsolver_normal_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = FORCESNLPsolver_normal_py.FORCESNLPsolver_normal_solve(PARAMS) returns 
...
#_lib = ctypes.CDLL(os.path.join(os.getcwd(),'FORCESNLPsolver_normal/lib/FORCESNLPsolver_normal.so')) 
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver_normal/lib/FORCESNLPsolver_normal_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver_normal_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'FORCESNLPsolver_normal/lib/libFORCESNLPsolver_normal_withModel.so'))
    csolver = getattr(_lib,'FORCESNLPsolver_normal_solve')

class FORCESNLPsolver_normal_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver_normal_params = {'xinit' : np.array([]),
'x0' : np.array([]),
...
FORCESNLPsolver_normal_params_types = {'xinit' : np.float64,
'x0' : np.float64,
'all_parameters' : np.float64,
'num_of_threads' : np.uint32,
}

class FORCESNLPsolver_normal_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
FORCESNLPsolver_normal_outputs = {'x01' : np.array([]),
'x02' : np.array([]),
'x03' : np.array([]),
'x04' : np.array([]),
'x05' : np.array([]),
...
class FORCESNLPsolver_normal_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
csolver.argtypes = ( ctypes.POINTER(FORCESNLPsolver_normal_params_ctypes), ctypes.POINTER(FORCESNLPsolver_normal_outputs_ctypes), ctypes.POINTER(FORCESNLPsolver_normal_info), ctypes.POINTER(FILE))
...
solve = FORCESNLPsolver_normal_solve
