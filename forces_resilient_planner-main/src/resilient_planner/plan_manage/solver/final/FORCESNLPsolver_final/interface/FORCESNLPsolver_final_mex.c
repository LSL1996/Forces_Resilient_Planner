...
extern void FORCESNLPsolver_final_casadi2forces(FORCESNLPsolver_final_float *x, FORCESNLPsolver_final_float *y, FORCESNLPsolver_final_float *l, FORCESNLPsolver_final_float *p, FORCESNLPsolver_final_float *f, FORCESNLPsolver_final_float *nabla_f, FORCESNLPsolver_final_float *c, FORCESNLPsolver_final_float *nabla_c, FORCESNLPsolver_final_float *h, FORCESNLPsolver_final_float *nabla_h, FORCESNLPsolver_final_float *hess, solver_int32_default stage, solver_int32_default iteration, solver_int32_default threadID);
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help FORCESNLPsolver_final_mex' for details.");
    }    
	if (nlhs > 3) 
	{
